...
X_bp_raw = pd.read_excel("C:\\Users\\ds-kg\\Desktop\\Выпускная квалификационная работа\\X_bp.xlsx").drop("Unnamed: 0", axis="columns")
X_nup_raw = pd.read_excel("C:\\Users\\ds-kg\\Desktop\\Выпускная квалификационная работа\\X_nup.xlsx")
...
##model.save("C:\\Users\\ds-kg\\Desktop\\Выпускная квалификационная работа\\Neural model")
## Сохранение модели через keras

##model = keras.models.load_model('C:\\Users\\ds-kg\\Desktop\\Выпускная квалификационная работа\\Neural model')
